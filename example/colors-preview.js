...
for (var i = 0; i< colors.length;i++) {
    var starter = `{"input":"/tmp/data/pet.json","format":"lite","markdown":true,"theme":"blue","fixedNav":true,"output":"/tmp/pet.html","autoTags":true,"noDate":false,"noCredit":false,"noNav":false,"noRequest":false,"indent_num":3,"collapse":{"path":false,"method":false,"tool":true}}`;
    var config = JSON.parse(starter);
    var color = colors[i];
    config.theme = color;
    config.output = "/tmp/pet-"+color+".html";
